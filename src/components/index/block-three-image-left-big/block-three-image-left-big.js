...
import "./block-three-image-left-big.css";

export default class BlockThreeImageLeftBig extends Component {
    // constructor(props) {
    //     super(props)
    // }
    ...
    render() {
        ...
        return (
            <div className="block-three-image-left-big" data-id={data.templateid}>
                {createHTML}
            </div>
        );
    }
