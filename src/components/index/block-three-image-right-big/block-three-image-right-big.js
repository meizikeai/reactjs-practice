...
import "./block-three-image-right-big.css";

export default class BlockThreeImageRightBig extends Component {
    // constructor(props) {
    //     super(props)
    // }
    ...
    render() {
        ...
        return (
            <div className="block-three-image-right-big" data-id={data.templateid}>
                {createHTML}
            </div>
        );
    }
